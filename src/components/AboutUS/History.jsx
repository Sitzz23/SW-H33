    ...
    return (
        <div className='flex flex-col'>
            <div className='flex justify-around'>
                <div className='w-1/2 p-8'>
                    ...
                    <p className='text-[#9F9F9F] '>
                        ...
                        appointment of the Indian Universities Commission in
                        1902, issue of the Indian Education Policy Resolution in
                        1904, and the Governor General’s policy statement of
                        1913 stressing the importance of technical education,
                        the establishment of IISc in Bangalore, Institute for
                        Sugar, Textile & Leather Technology in Kanpur, N.C.E. in
                        Bengal in 1905, and industrial schools in several
                        provinces.
                    </p>
                </div>
                <div className='p-8 w-[38vw] pt-14 flex flex-col'>
                    ...
                    <p className='text-center text-[#9F9F9F]'>
                        Technical education in India contributes a major share
                        to the overall education system and plays a vital role
                        in the social and economic development of our nation.
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <div className='px-8 font-normal '>
                    <p className='p-4 py-6'>
                        ...
                        advisory body to conduct a survey on the facilities
                        available for technical education and to promote
                        development in the country in a coordinated and
                        integrated manner. And to ensure the same, as stipulated
                        in the National Policy of Education (1986), AICTE was
                        vested with:
                    </p>
                ...
                <div className='flex p-8'>
                    <div className='flex flex-col items-center w-1/3'>
                        <h1 className='text-[#FF725E] font-bold text-6xl p-4'>
                            1943
                        </h1>
                ...
                <div className='flex flex-col w-3/5'>
                    <div className='px-12'>
                        ...
                        <p className='p-8 w-2/3  pl-0'>
                            ...
                            context of proliferation of technical institutions,
                            maintenance of standards, and other related matters.
                            The Working Group recommended that AICTE be vested
                            with the necessary statutory authority for making it
                            more effective, which would consequently require
                            restructuring and strengthening with the necessary
                    ...
                    <div className='px-12'>
                        ...
                        <p className='p-8 w-2/3  pl-0'>
                            ...
                            Parliament) <br />
                            <br />
                            The AICTE Act was constituted to provide for the
                            establishment of an All India Council for Technical
                            Education with a view to proper planning and
                            co-ordinated development of a technical education
                            system throughout the country, the promotion of
                            qualitative improvements of such education in
                            relation to planned quantitative growth, and
                            regulation & proper maintenance of norms and
                            standards in the technical education system and for
            ...
            <p className='px-12 py-8 text-md h-full'>
                The purview of AICTE (the Council) covers programmes of
                technical education including training and research in
                Engineering, Technology, Architecture, Town Planning,
                Management, Pharmacy, Applied Arts and Crafts, Hotel Management
                and Catering Technology etc. at different levels.
            </p>
        </div>
    );
}
